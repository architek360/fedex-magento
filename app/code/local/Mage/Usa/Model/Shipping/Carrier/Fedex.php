    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    $order = new Mage_Sales_Model_Order();
 	$order_id = $request->getOrderShipment()->getOrder()->getIncrementId();
        ...
        if($payment_method =='cashondelivery')
            {
                ...
                $SpecialServicesRequested= array(
                    // 'SpecialServiceTypes' => array('COD','DELIVERY_ON_INVOICE_ACCEPTANCE'),
                ...
                //     'DeliveryOnInvoiceAcceptanceDetail'=>array(
                //         'Recipient' => array(
                //     'Contact' => array(
                ...
                //     ),
                //     'Address' => array(
                //         'StreetLines' => $request->getRecipientAddressStreet1(),
    ...
    protected function _doShipmentRequest(Varien_Object $request)
    {
        ...
        if ($response->HighestSeverity != 'FAILURE' && $response->HighestSeverity != 'ERROR') {
            ...
            $shippingLabelContent[]=$response->CompletedShipmentDetail->AssociatedShipments->Label->Parts->Image;
            
            if($response->CompletedShipmentDetail->ShipmentDocuments->Parts->Image)
            $shippingLabelContent[]=$response->CompletedShipmentDetail->ShipmentDocuments->Parts->Image;

            if($response->CompletedShipmentDetail->CompletedPackageDetails->PackageDocuments[0]->Parts->Image)
            $shippingLabelContent[]=$response->CompletedShipmentDetail->CompletedPackageDetails->PackageDocuments[0]->Parts->Image;
